...
def test_build_job_payload_does_not_add_estimated_bounty_signal_tags():
    job = NormalizedJob(
        source_job_id="founding-ai",
        canonical_url="https://open-gradient.ai/careers/principal-ai-engineer",
        title="Principal AI Engineer",
    ...
    assert "estimated_bounty_rate_pct" not in payload["signal_tags"]
    assert "estimated_bounty_rule_version" not in payload["signal_tags"]
    assert "estimated_bounty_confidence" not in payload["signal_tags"]


def test_build_job_payload_does_not_add_estimated_bounty_without_salary():
    job = NormalizedJob(
        source_job_id="founding-ai",
        canonical_url="https://open-gradient.ai/careers/principal-ai-engineer",
        title="Principal AI Engineer",
